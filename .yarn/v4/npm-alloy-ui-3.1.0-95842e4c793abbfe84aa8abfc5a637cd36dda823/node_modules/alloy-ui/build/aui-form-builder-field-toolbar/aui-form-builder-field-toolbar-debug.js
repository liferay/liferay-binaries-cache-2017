YUI.add('aui-form-builder-field-toolbar', function (A, NAME) {
...
A.FormBuilderFieldToolbar = A.Base.create('form-builder-field-toolbar', A.Base, [], {
    ...
    TPL_TOOLBAR_ITEM: '<button type="button" class="btn btn-default ' + CSS_TOOLBAR_ITEM + ' {buttonClass}">' +
...
}, '3.1.0', {"requires": ["aui-classnamemanager", "base", "node-base"], "skinnable": true});
