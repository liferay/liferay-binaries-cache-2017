...
exports.templates = exports.ClaySelect = undefined;
...
goog.loadModule(function (exports) {
  ...
  function $select(opt_data, opt_ijData, opt_ijData_deprecated) {
    ...
    /** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
    var name = soy.asserts.assertType(opt_data.name == null || goog.isString(opt_data.name) || opt_data.name instanceof goog.soy.data.SanitizedContent, 'name', opt_data.name, '!goog.soy.data.SanitizedContent|null|string|undefined');
    var selectAttributes__soy55 = function selectAttributes__soy55() {
    ...
    for (var option94Index = 0; option94Index < option94ListLen; option94Index++) {
      ...
      var optionAttributes__soy81 = function optionAttributes__soy81() {
...
var ClaySelect = function (_Component) {
  _inherits(ClaySelect, _Component);
...
_metalSoy2.default.register(ClaySelect, templates);
exports.ClaySelect = ClaySelect;
exports.templates = templates;
exports.default = templates;
/* jshint ignore:end */
//# sourceMappingURL=ClaySelect.soy.js.map