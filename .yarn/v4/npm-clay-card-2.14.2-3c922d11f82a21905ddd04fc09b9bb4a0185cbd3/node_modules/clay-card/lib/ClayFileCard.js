...
exports.ClayFileCard = undefined;
...
var _ClayFileCardSoy = require('./ClayFileCard.soy.js');

var _ClayFileCardSoy2 = _interopRequireDefault(_ClayFileCardSoy);
 ...
 */
var ClayFileCard = function (_ClayComponent) {
	_inherits(ClayFileCard, _ClayComponent);

	function ClayFileCard() {
		_classCallCheck(this, ClayFileCard);

		return _possibleConstructorReturn(this, (ClayFileCard.__proto__ || Object.getPrototypeOf(ClayFileCard)).apply(this, arguments));
	}
...
ClayFileCard.STATE = {
  ...
  * @type {?string}
  */
	icon: _metalState.Config.string().value('documents-and-media'),
...
(0, _metalWebComponent2.default)('clay-file-card', ClayFileCard);

_metalSoy2.default.register(ClayFileCard, _ClayFileCardSoy2.default);

exports.ClayFileCard = ClayFileCard;
exports.default = ClayFileCard;
//# sourceMappingURL=ClayFileCard.js.map